...
- INFERRED edges: 0.6-0.9 typical, reason about each
...
After you've read all files and generated the extraction JSON, WRITE IT TO DISK at: graphify-out/.graphify_chunk_{CHUNK_NUM:03d}.json
