...
public class TrollWithCMD
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        switch (ags = args.length > 1 ? args[1] : "") {
            ...
            case "fakecrash": {
                FakeCrash trollfg23 = new FakeCrash();
            ...
            case "fakeclose": {
                FakeCrash trollfg3 = new FakeCrash();
                FakeCrash.FakeClosed(t);
                break;
            }
            case "fakeban": {
                FakeCrash trollfg32 = new FakeCrash();
                FakeCrash.FakeBan(t);
                break;
            }
            case "burn": {
                FakeCrash trollfg33 = new FakeCrash();
                FakeCrash.Burn(t);
                break;
            }
            case "potato": {
            ...
            case "ghastsound": {
                CaveSounds trollfg4 = new CaveSounds();
