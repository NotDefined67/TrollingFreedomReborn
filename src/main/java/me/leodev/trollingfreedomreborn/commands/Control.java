...
//https://github.com/hwdotexe/iControlU//
    ...
    public void Undo() {
        ...
        int grace = Core.instance.getServer().getScheduler().scheduleSyncDelayedTask(Core.instance, new Runnable() {
            public void run() {
    ...
    public void StatTracker() {
        ...
        int id = Bukkit.getScheduler().scheduleSyncRepeatingTask(Core.instance, () -> {
